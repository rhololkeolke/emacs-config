...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(("t" "todo" entry (file (lambda () (expand-file-name (format "%s/refile.org" rhol-org-directory))))
          ...
          ("r" "respond" entry (file (lambda () (expand-file-name (format "%s/refile.org" rhol-org-directory))))
           "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n" :clock-in t :clock-resume t :immediate-finish t)
          ("n" "note" entry (file (lambda ()(expand-file-name (format "%s/refile.org" rhol-org-directory))))
           "* %? :NOTE:\n%U\n" :clock-in t :clock-resume t)
          ...
          ("W" "wait-for-reply" entry (file+headline (lambda() (expand-file-name (format "%s/refile.org" rhol-org-directory))) "Waiting")
           "* WAIT %u %a %?\n")
          ))
#+END_SRC
    ...
    (if org-gcal-file-alist nil
      (progn
        (let ((calendar-name (read-string "calendar name: "))
          ...
          (customize-save-variable
           'org-gcal-file-alist
           (list (cons calendar-name (concat "%s/%s" rhol-org-directory calendar-file))))))))
