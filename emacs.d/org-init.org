...
#+BEGIN_SRC emacs-lisp
  (message "org-init.org: cquery")
  (use-package lsp-mode
    :bind (("C-M-," . xref-pop-marker-stack)
           ("C-M-." . xref-push-marker-stack)
...
#+BEGIN_SRC emacs-lisp
  (use-package ledger
    :config (add-to-list 'auto-mode-alist '("personal\\.dat\\'" . ledger-mode)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defcustom rhol-use-mu4e nil
    ...
    :type 'boolean
    :group 'rhol-email
    :tag "Set true to enable email and set default mail settings")
